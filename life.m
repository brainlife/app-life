function [fh, fe] = life(dwiFile, dwiFileRepeat, t1File, fgProbFileName, fgDetFileName)
...
%fgFileName    = fullfile(lifeDemoDataPath('tractography'), 'life_demo_mrtrix_csd_lmax10_probabilistic.mat');
...
fe = feConnectomeInit(dwiFile,fgProbFileName,feFileName,[],dwiFileRepeat,t1File);
...
%fgFileName    = fullfile(lifeDemoDataPath('tractography'), 'life_demo_mrtrix_tensor_deterministic.mat');
...
% compute model accuracry, and perform statistical tests. You can type
% help('feBuildModel') in the MatLab prompt for more information.
fe = feConnectomeInit(dwiFile,fgDetFileName,feFileName,[],dwiFileRepeat,t1File);
